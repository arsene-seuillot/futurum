...
export default function Questionnaire() {
    ...
    return (
        <div className="container py-8">
          ...
          ${answers[index] === true ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-blue-100"}
        `}
                        >
                            Oui
                        </button>
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl font-medium transition 
          ${answers[index] === false ? "bg-orange-500 text-white" : "bg-gray-200 text-gray-800 hover:bg-orange-100"}
        `}
                        >
                            Non
                        </button>
